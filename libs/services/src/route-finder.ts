import { Route } from '@map-app/models';
...
export class RouteFinder {
  ...
  async call(): Promise<Route> {
    const apiUrl = process.env.CITYMAPPER_API_URL || 'https://api.external.citymapper.com/api/1/directions/transit?';
  ...
  static async call(startLocation: string, endLocation: string): Promise<Route> {
